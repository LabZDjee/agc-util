...
- from version 1.4, some legacy peculiarities are also addressed: section  `EquationAdditionals` is optional and *metaTag* `$VLowLimit`  is not properly closed with a double-quote
